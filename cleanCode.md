...
## Tabla  de  contenido
  ...
  4.  [ Objetos  y  estructuras de datos  ] ( # objetos y estructuras de datos ) _
  5.  [ Clases ] ( # clases )
  6.  [ SÓLIDO ] ( # sólido )
  7.  [ Pruebas ] ( # pruebas )
  8.  [ Simultaneidad ] ( # simultaneidad )
  9.  [ Manejo de errores  ] ( # error - manejo )
...
! [ Imagen humorística de la  estimación de la calidad del software como un recuento de cuántos improperios           
gritas  al leer el código ] ( https : //www.osnews.com/images/comics/wtfm.jpg  )  

 Principios de ingeniería  de software , de Robert C. el libro de martin    
[*Código limpio*](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882),
adaptado para TypeScript. Esta no es una guía de estilo. Es una guía para producir _    
Software [ legible ,  reutilizable y  refactorizable ] (  https : //github.com/ryanmcdermott/3rs-of-software-architecture ) en TypeScript.

No  todos los  principios  aquí  descritos tienen  que  ser  seguidos estrictamente  , e incluso menos serán     
 aceptado  universalmente . _ Estas son pautas y nada más , pero son _         
 codificados  durante  muchos  años  de  experiencia colectiva  por los autores de _    
* Código limpio  * .
...
you can quickly go over the entire list of todos.  
 ...
 Sin embargo , tenga en  cuenta  que un comentario * TODO * no es una excusa para un código incorrecto .            

** Malo : **

`` `s
función getActiveSubscriptions(): Promesa<Suscripción[]> {
  // asegúrese de que ` dueDate` esté indexado.
  return db.subscriptions.find({ fecha de vencimiento: { $lte: nueva fecha() } });
}
` ``
...
`` `s
función getActiveSubscriptions(): Promesa<Suscripción[]> {
  // TODO: asegúrese de que ` dueDate` esté indexado.
  return db.subscriptions.find({ fecha de vencimiento: { $lte: nueva fecha() } });
}
` ``

** [ ⬆  volver  arriba ] ( # tabla de contenidos ) ** _  _ _

## Traducciones

Esto también  está disponible  en  otros  idiomas :
-  ! [ br ] ( https : //raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Brazil.png) **Portugués brasileño**: [vitorfreitas/clean-code-typescript](https ://github.com/vitorfreitas/clean-code-typescript)
...
-  ! [ fr ] ( https : //raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/France.png) **Francés**: [ralflorent/clean-code-typescript](https: //github.com/ralflorent/clean-code-mecanografiado)
-  ! [ de ] ( https : //raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Germany.png) **Alemán**: [mheob/clean-code-typescript](https: //github.com/mheob/clean-code-typescript)
...
-  ! [ es ] ( https : //raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Spain.png) **Español**: [JoseDeFreitas/clean-code-typescript](https: //github.com/JoseDeFreitas/clean-code-typescript)
...
Las referencias  se  agregarán una  vez que se completen las traducciones .      
Consulte  esta  [ discusión ] ( https : //github.com/labs42io/clean-code-typescript/issues/15) para obtener más detalles y avances.
Puedes  hacer  una contribución  indispensable a la comunidad de * Clean Code * traduciendo esto a tu idioma .            
